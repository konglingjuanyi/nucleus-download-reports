...
public class BaseServiceImpl implements BaseService {
    ...
    @Override
    public void setMetrics(ColumnList<String> usageDataSet, Map<String, Object> dataMap, String title, String leastId) {
    ...
    public void setResourceMetrics(ColumnList<String> usageDataSet, Map<String, Object> dataMap, String title,
        ...
        dataMap.put(appendHyphen(title, ExportConstants.TIME_SPENT),
            usageDataSet.getLongValue(appendTilda(leastId, ConfigConstants.TIME_SPENT), 0L));
        dataMap.put(appendHyphen(title, ExportConstants.ANSWER_STATUS),
            usageDataSet.getStringValue(appendTilda(leastId, ConfigConstants._QUESTION_STATUS), ConfigConstants.NA));
