...
public class DataServiceImpl implements DataService {
	...
	@Override
	public List<String> getClassMembersList(String classId, String userId, String userRole) throws InterruptedException, ExecutionException {
	...
	@Override
	public void setUsageData(Map<String, Object> dataMap, String title, String rowKey, String collectionType) throws ConnectionException {
		ColumnList<String> usageDataSet = cqlDAO.readByKey(ColumnFamilyConstants.CLASS_ACTIVITY,
				baseService.appendTilda(rowKey, collectionType));
		long views = 0;
