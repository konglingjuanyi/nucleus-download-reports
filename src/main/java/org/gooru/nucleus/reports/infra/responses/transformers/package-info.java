...
/**
 * This package contains machinery to use the Message coming from Message Bus from other handlers and carving out an
 * Http
 * response out of it.
 ...
 * <p>
 * The implementation contract is provided by ResponseTransformer and is implemented by HttpResponseTransformer. Here
 * is how
 ...
 * ---------------------|
 * <p>
 * If header contains header named MessageConstants.MSG_OP_STATUS with header value MessageConstants
 * .MSG_OP_STATUS_SUCCESS
 ...
 * value: Http headers that need to be sent. Type is Json object which contains key as header names and values as
 * header values.
 * The keys and values should be string.
 * <p>
 * key: MessageConstants.MSG_HTTP_BODY
 * value: This is envelope of body and it could contain either of MessageConstants.MSG_HTTP_RESPONSE, or
 * MessageConstants.MSG_HTTP_ERROR
 * or MessageConstants.MSG_HTTP_VALIDATION_ERROR. Which one should be read is dependent on value of MessageConstants
 * .MSG_OP_STATUS
 * message header as outlined above. In case value is MessageConstants.MSG_OP_STATUS_SUCCESS, MessageConstants
 * .MSG_HTTP_RESPONSE is used.
